...
// Nanti, bagian ini bisa kamu ganti dengan logic fetch API
const KATEGORI_DATA = {
  makanan: {
  ...
  minuman: {
    ...
    image: "/images/sampel_hero_minuman.jpg", // (ganti gambar jika ada)
    umkmList: Array(5).fill({
      ...
      image: "/images/sampel_kopi.jpg", // (ganti gambar jika ada)
    }),
  },
  jasa: {
    ...
    image: "/images/sampel_hero_jasa.jpg", // (ganti gambar jika ada)
    umkmList: Array(3).fill({
      ...
      image: "/images/sampel_laundry.jpg", // (ganti gambar jika ada)
    }),
  },
  barang: {
    ...
    image: "/images/sampel_hero_barang.jpg", // (ganti gambar jika ada)
    umkmList: Array(6).fill({
      ...
      image: "/images/sampel_batik.jpg", // (ganti gambar jika ada)
    }),
  },
  lainnya: {
    ...
    image: "/images/sampel_hero_lainnya.jpg", // (ganti gambar jika ada)
    umkmList: Array(2).fill({
      ...
      image: "/images/sampel_kelontong.jpg", // (ganti gambar jika ada)
    }),
  },
};
// --- AKHIR DATA DUMMY ---
...
const KategoriPage = () => {
  ...
  // Jika slug tidak ditemukan di data, fallback ke 'makanan'
  ...
  return (
    <div className="bg-light min-h-screen">
      ...
      <PageContainer variant="wide" className="py-10">
        <h2 className="text-center text-2xl font-semibold text-dark">
          Menampilkan semua UMKM Kudus <br />
          <span className="font-normal text-dark/80">
            dalam kategori{" "}
            {/* 4. Tampilkan slug yang aktif */}
        ...
        {/* Grid Card - Sekarang Dinamis */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-items-center mt-10">
          {/* 5. Gunakan data list dari kategoriData */}
          {kategoriData.umkmList.map((umkm, index) => (
            <UMKMCard key={index} data={umkm} />
          ))}
        </div>

        {/* Pagination (Masih statis, bisa kamu kembangkan nanti) */}
