        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Perbarui Foto Profil dan Informasi anda disini</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Foto Profil mu</h3>
                ...
                <div
                  ...
                  className={`relative border-2 border-dashed rounded-2xl p-8 text-center transition-all ${
                    isDragging ? "border-orange bg-orange-50" : "border-gray-300"
                  }`}
                >
                  {photoUrl ? (
                    <img
                  ...
                  <p className="mt-4 text-sm font-medium text-orange">
                    {isDragging ? "Lepaskan untuk upload" : "Klik untuk upload atau seret ke sini"}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">SVG, PNG, JPG ( MAX 800 x 800 px )</p>
